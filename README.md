# PDF FAQ Knowledge Bot - Education Planning Evidence Review Simple RAG - Beginner Custom 5

    ## Project Overview

    PDF FAQ Knowledge Bot - Education Planning Evidence Review Simple RAG - Beginner Custom 5 is a complete full-stack AI project for **Simple RAG** at **Beginner** difficulty. It includes a FastAPI backend, a React frontend, sample documents, vector search with ChromaDB support, source citations, timeline logs, structured run storage, Docker files, and tests.

    PDF FAQ Knowledge Bot for answering repeat questions from uploaded documents. Tailored topic: Education Planning Evidence Review Simple RAG - Beginner Custom 5.
    ...
    ```text
    ai-simple-rag-education-planning-evidence-review-simple-rag-beginner-custom-5/
      backend/
        app/
          main.py
          config.py
